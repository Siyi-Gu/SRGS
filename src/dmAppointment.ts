...
function promptAndAsk(prompt: string, nomatch:string ): MachineConfig<SDSContext, any, SDSEvent> {
    return ({
        initial: 'prompt',
        states: {
            prompt: {
...
const helpMsg = ['help', 'I need help']

function helpRequest() {
    return {target : 'help', cond: (context:SDSContext) => helpMsg.includes(context.recResult)}
}
...
export const dmMachine: MachineConfig<SDSContext, any, SDSEvent> = ({   
    ...
    states: {
        ...
        MAXSPEECH:{
            states: {
                prompt: {entry: say("Sorry, I didn't recieve any response. Directing to the initial menu.")}
            },
        ...
        help:{
            initial: 'prompt',
            states: {
                prompt: { entry: say("OK. I can help you with creading an appointment, making a todo list or setting up a timmer.")}
            },
            on: { ENDSPEECH: "init" }
        },
}})
